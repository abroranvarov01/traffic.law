        ...
        <div className="flex flex-col border-t border-white/10">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="group relative border-b border-white/10 py-12 md:py-16 hover:bg-white/[0.02] transition-all duration-500"
            >
              <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 px-4">
                ...
                <div className="flex flex-row lg:flex-col gap-6 lg:w-1/4 shrink-0">
                  ...
                  <div className="relative w-32 h-32 md:w-full md:h-48 overflow-hidden rounded-sm border border-white/5 shadow-2xl">
                    <Image
                      src={project.image}

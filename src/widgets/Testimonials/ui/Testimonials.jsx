    ...
    <section className="relative bg-[#070707] py-4 md:py-20 overflow-hidden text-white">
      ...
      <Container className="relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-12">
          {items.map((item, index) => (
            <motion.div
              ...
              className="group bg-white/[0.02] backdrop-blur-md border border-white/5 p-6 md:p-8 flex flex-col justify-between h-full hover:border-[#C59D5F]/20 transition-all duration-500"
            >
              <div>
        ...
        <div className="flex justify-center relative z-30">
          <GoldButton className="scale-90 md:scale-100">{t.cta}</GoldButton>
        </div>
      </Container>
    </section>
  );

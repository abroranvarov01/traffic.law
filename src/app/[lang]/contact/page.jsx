...
export default async function ContactPage({ params }) {
  ...
  return (
    <main className="bg-[#0a0a0a] min-h-screen">
          ...
          >
            ...
            <div className="flex flex-col">
              <h1 className="text-white text-3xl md:text-5xl font-serif italic mb-6 tracking-widest uppercase">
                {dict.contact_page_title || "Contact Us"}
              </h1>
      ...
      {/* --- 2. Widgets Section --- */}
      {/* Widgetlarga dict va lang uzatiladi, shunda ichidagi formalar va xaritalar ko'p tilli bo'ladi */}

      <ContactSection dict={dict} lang={lang} />

      <ContactMap dict={dict} lang={lang} />
    </main>
  );
}
